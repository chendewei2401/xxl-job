package com.cmcc.pay.admin.core.util;
...
public class MailUtil {
	...
	static{
		host = "job.mail.host";
		port = "xxl.job.mail.port";
		username = "job.mail.username";
		password = "job.mail.password";
		sendFrom = "job.mail.sendFrom";
		sendNick = "job.mail.sendNick";
	}
				...
				public void run() {
					while(total < 10){
						String mailBody = "<html><head><meta http-equiv="
								...
								+ "></head><body><h1>test</h1>test</body></html>";
